...
(async () => {
  try {
    ...
    //Insert Data for WalkRating
      ...
      VALUES
        ((SELECT request_id FROM WalkRequests WHERE status = 'accepted' LIMIT 1), (SELECT user_id FROM Users WHERE username = 'bobwalker'), (SELECT user_id FROM Users WHERE username = 'alice123'), 4),
